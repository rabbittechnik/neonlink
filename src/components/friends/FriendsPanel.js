...
export function FriendsPanel({ displayName, friendCode, activeWorkspaceId, activeSection, workspaceInviteCode, onWorkspaceInviteCodeChange, onJoinWorkspace, generatedWorkspaceInviteCode, onCreateWorkspaceInvite, onRegenerateFriendCode, inviteInfo, friendInfo, friendSearch, onFriendSearchChange, onSearchFriends, friendSearchResults, onSendFriendRequest, incomingFriendRequests, resolveRequestUser, onAcceptFriendRequest, onRejectFriendRequest, friends, friendGroupOptions, onSetFriendGroups, onAddFriendByCode, onOpenFriendProfile, onOpenPrivateChat, }) {
    ...
    return (_jsxs("div", { className: "space-y-3 min-w-0", children: [_jsx(FriendsHeader, { onAddFriend: scrollToJoin, onSearch: () => setSearchOpen((v) => !v), searchActive: searchOpen }), searchOpen ? (_jsx(FriendSearchStrip, { friendSearch: friendSearch, onFriendSearchChange: onFriendSearchChange, onSearchFriends: onSearchFriends, results: friendSearchResults, onSendFriendRequest: onSendFriendRequest })) : null, _jsxs("p", { className: "text-[10px] font-medium text-white/90 leading-relaxed px-0.5", children: ["Eingeloggt als ", _jsx("span", { className: "text-cyan-100 font-semibold", children: displayName }), ". Gruppen (Familie, Feuerwehr, \u2026) ordnest du nur f\u00FCr dich zu \u2014 andere sehen deine Zuordnung nicht."] }), (inviteInfo || friendInfo) && (_jsxs("div", { className: "rounded-2xl border border-white/10 bg-white/5 px-3 py-2 space-y-1 text-[11px]", children: [inviteInfo ? _jsx("p", { className: "text-white leading-snug font-medium", children: inviteInfo }) : null, friendInfo ? _jsx("p", { className: "text-cyan-100 font-semibold leading-snug", children: friendInfo }) : null] })), _jsx(InviteCodeCard, { friendCode: friendCode, onCopyFriendCode: copyFriendCode, onRegenerateFriendCode: handleRegenerate, activeWorkspaceId: activeWorkspaceId, workspaceInviteCode: workspaceInviteCode, onWorkspaceInviteCodeChange: onWorkspaceInviteCodeChange, onJoinWorkspace: () => onJoinWorkspace(), generatedWorkspaceInviteCode: generatedWorkspaceInviteCode, onCreateWorkspaceInvite: onCreateWorkspaceInvite, copyHint: copyHint }), _jsx(JoinByCodeCard, { highlight: joinPulse, onAddFriendByCode: onAddFriendByCode }), _jsx(FriendRequestsCard, { requests: incomingFriendRequests, resolveUser: resolveRequestUser, onAccept: onAcceptFriendRequest, onReject: onRejectFriendRequest }), _jsx(FriendsList, { friends: friends, activeSection: activeSection, groupOptions: friendGroupOptions, onSetFriendGroups: onSetFriendGroups, onOpenFriendProfile: onOpenFriendProfile, onOpenPrivateChat: handleOpenChat, chatBusyId: chatBusyId })] }));
}
