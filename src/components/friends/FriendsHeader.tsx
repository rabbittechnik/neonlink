  ...
  return (
    <div className="flex items-center justify-between gap-2 min-w-0">
      <div className="flex items-center gap-2 min-w-0">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl bg-cyan-500/15 border border-cyan-400/25 text-cyan-200">
          <Users className="h-4 w-4" />
        </div>
        <div className="min-w-0">
          <h2 className="text-base font-semibold tracking-tight text-white truncate">Freunde</h2>
          <p className="text-[10px] text-white/45 truncate">Social · nur für dich sichtbar</p>
        </div>
      </div>
