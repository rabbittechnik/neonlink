    ...
    <div className="flex flex-col min-h-0 min-w-0 h-full">
      <Card className="flex-1 min-h-0 rounded-3xl border border-white/10 bg-white/5 text-white backdrop-blur-xl flex flex-col overflow-hidden">
        ...
        <CardContent className="flex-1 min-h-0 overflow-y-auto p-4 space-y-2">
          {items.length === 0 ? (
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-12 text-center text-sm font-medium text-white/90">
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="text-sm font-semibold text-white leading-snug break-words">{item.title}</div>
                    {item.subtitle ? (
                      <div className="text-xs font-medium text-white/90 mt-1 leading-snug break-words">{item.subtitle}</div>
                    ) : null}
                  </div>
                </button>
              );
