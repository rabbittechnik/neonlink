...
export const MIETE_PAID_LABELS: Record<MietePaidBy, string> = {
  person1: "Person 1",
  person2: "Person 2",
...
export const HOUSEHOLD_SIMPLE_COST_KEYS: Array<{
  centsKey: keyof HouseholdMonthlyFixedCosts;
  label: string;
  hint?: string;
}> = [
...
export function emptyHouseholdCosts(): HouseholdMonthlyFixedCosts {
  return {
    mieteCents: 0,
...
export function sumHouseholdMonthlyCents(costs: HouseholdMonthlyFixedCosts): number {
  return (
    costs.mieteCents +
    costs.internetCents +
