...
export const CALENDAR_SECTION_META: Record<
  SectionId,
...
export const CALENDAR_UPCOMING_CARD: Record<
  SectionId,
  { wrap: string; iconWrap: string; clockClass: string }
> = {
  familie: {
...
export const CALENDAR_SECTION_IDS = Object.keys(CALENDAR_SECTION_META) as SectionId[];
